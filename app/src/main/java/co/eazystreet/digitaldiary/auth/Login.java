 package co.eazystreet.digitaldiary.auth;
 ...
 import co.eazystreet.digitaldiary.MainActivity;
 import co.eazystreet.digitaldiary.R;
 import co.eazystreet.digitaldiary.Splash;
 ...
 public class Login extends AppCompatActivity {
     ...
     protected void onCreate(Bundle savedInstanceState) {
         ...
         getSupportActionBar().setTitle("Login to DigitalDiary");
